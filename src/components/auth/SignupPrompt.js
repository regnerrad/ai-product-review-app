...
export default function SignupPrompt({ isOpen, onClose, initialMode = 'signin' }) {
  ...
  // Different content based on mode (same gradient)
  const getHeaderContent = () => {
    if (showForgotPassword) {
      ...
      return {
        ...
        subtitle: "Join thousands making smarter purchase decisions"
      };
    } else {
      return {
        title: "Welcome Back",
        subtitle: "Sign in to continue your product research"
      };
    }
  };
    ...
    return (
      <Dialog open={isOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="bg-white border-slate-200 max-w-md p-0 overflow-hidden rounded-2xl max-h-[90vh] flex flex-col">
          {/* Gradient Header */}
          <div className="bg-gradient-to-r from-indigo-500 to-purple-500 px-8 py-8 text-white flex-shrink-0 relative">
            <button
            ...
            <p className="text-center text-indigo-100 text-sm max-w-xs mx-auto">
